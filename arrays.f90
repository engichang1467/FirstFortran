program array
  ...
  ! Imply do loop
  ! it prints 1 to 5 five times in a line
  do n = 1,5
  ...
  print "(i2)", rank(a4) ! get number of dimension
  print "(i2)", shape(a4) ! get the element of each dimension
  ...
  ! To change the value inside the array
  a2 = (/1,2,3,6,7/)
